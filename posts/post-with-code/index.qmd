...
Pero... en realidad los softwares no utilizan ${(X^{\prime}X)}^{-1}X^{\prime}y$. Al parecer, invertir matrices es “numéricamente inestable” y computacionalmente ineficiente^[Sosa, W. (2015) El lado oscuro de la econometría. TEMAS Grupo Editorial, Buenos Aires]. Por ejemplo, la función *lm()* realiza una transformación QR (?) para estimar $\hat{\beta}$:
